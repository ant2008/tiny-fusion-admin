...
import { editSchema, searchSchema, showColumns } from '@/wscore/views/met/MVendor/MVendorData'
...
export default defineComponent({
  name: 'MVendor',
  components: { WsModalForm, WsToolBar, WsTable, ContentWrap, SearchForm, ElButton },
  props: {},
  setup() {
    const { t } = useI18n()
