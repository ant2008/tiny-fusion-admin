...
const autoCodeType = getSyscodeSelect('S67')
// const autoCodeRelaType = getSyscodeSelect('S67')
...
export const showColumns = reactive<TableColumn[]>([
  ...
  },
  {
    ...
    minWidth: 120,
    formatter: (cellValue) => {
      return renderSysCodeDict(unref(cellValue).autocodeType, 'S67')
    }
  },
  {
    ...
    minWidth: 120,
    formatter: (cellValue) => {
      return renderSysCodeDict(unref(cellValue).autocodeRelatype, 'S70')
    }
  },
  {
  ...
  //   minWidth: 120,
  //   formatter: (cellValue) => {
  //     return renderSysCodeDict(unref(cellValue).autocodeRelatype, 'S67')
  //   }
  // },
  {
...
export const editSchema_Colset = reactive<TableColumn[]>([
  ...
  {
    field: 'autocodeColType',
    label: t('wsModule.autocodeColType'),
    minWidth: 120,
    editRender: { name: '' }
  },
  {
    field: 'autocodeColMaptype',
    label: t('wsModule.autocodeColMaptype'),
    minWidth: 120,
    editRender: { name: '' }
  },
  {
  ...
  {
    field: 'autocodeRequired',
    label: t('wsModule.autocodeRequired'),
    minWidth: 120,
    editRender: { name: '' }
  },
  // {
  ...
  // },
  {
    ...
    editRender: { name: '' },
    formatter: (cellValue) => {
      return renderSysCodeDict(unref(cellValue).autocodeFormType, 'S64')
    }
  },
  {
  ...
  // },
  {
    ...
    editRender: { name: '' },
    formatter: (cellValue) => {
      return renderTopSysCodeDict(unref(cellValue).autocodeFormOplist)
    }
  },
  // {
  ...
  // },
  {
    ...
    editRender: { name: '' },
    formatter: (cellValue) => {
      return renderSysCodeDict(unref(cellValue).autocodeQueryOpera, 'S69')
    }
  },
  // {
